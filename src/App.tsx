  ...
  <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm text-muted-foreground font-medium">
        <a href="#problems" className="hover:text-foreground transition-colors">Проблема</a>
        <a href="#lunar" className="hover:text-foreground transition-colors">Почему сейчас?</a>
    ...
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-full sm:w-auto inline-flex items-center gap-3 px-12 py-6 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-2xl font-black text-xl shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300 border-2 border-blue-400/30 ring-2 ring-blue-500/20 animate-pulse"
        >
      ...
      <div className="mt-20 relative">
        ...
        <div className="relative bg-gray-900/40 backdrop-blur-xl border border-border rounded-3xl p-6 md:p-10 grid grid-cols-2 md:grid-cols-4 gap-6 items-center grayscale opacity-60">
...
const LunarSection = () => (
  <section id="lunar" className="py-24 px-6 relative overflow-hidden border-y border-border bg-[#050a18]">
    <div className="max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="relative">
          ...
          <div className="relative space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-6 bg-white/5 rounded-2xl border border-border">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Идеальное время для аудита прошлого года, избавления от лишнего и составления стоп-листа. Энергия на спаде помогает легко отпускать ненужное и то, что мешает.</p>
                </div>
              </div>
              <div className="flex gap-4 p-6 bg-blue-600/20 rounded-2xl border border-blue-500/30 ring-1 ring-blue-500/20 shadow-lg shadow-blue-500/10">
                <div className="w-12 h-12 shrink-0 bg-blue-500 rounded-full flex items-center justify-center text-foreground font-bold animate-pulse text-sm">17.02</div>
                <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-8 bg-gray-900 border border-border rounded-3xl space-y-4 hover:border-blue-500/30 transition-all">
            <Stars className="text-yellow-500" />
            <h5 className="font-bold">Биоритмы</h5>
            <p className="text-muted-foreground text-sm">Мозг лучше фокусируется на будущем, когда внешняя среда находится в фазе обновления.</p>
          </div>
          <div className="p-8 bg-gray-900 border border-border rounded-3xl space-y-4 hover:border-blue-500/30 transition-all">
            <Sun className="text-orange-400" />
            <h5 className="font-bold">Лунный календарь</h5>
            <p className="text-muted-foreground text-sm">Планирование по фазам Луны помогает синхронизировать действия с естественными циклами энергии и продуктивности.</p>
          </div>
          <div className="p-8 bg-gray-900 border border-border rounded-3xl space-y-4 hover:border-blue-500/30 transition-all">
            <BrainCircuit className="text-purple-400" />
            <h5 className="font-bold">Помощник с искусственным интеллектом</h5>
            <p className="text-muted-foreground text-sm">Будет знать ваши цели, напоминать о приоритетах и не даст вам слиться с намеченного пути.</p>
          </div>
          <div className="p-8 bg-gray-900 border border-border rounded-3xl space-y-4 hover:border-blue-500/30 transition-all">
            <Calendar className="text-green-400" />
            <h5 className="font-bold">Мощная связка</h5>
            <p className="text-muted-foreground text-sm">Осознание своих желаний, энергия вселенной и возможности искусственного интеллекта.</p>
          </div>
        </div>
      </div>
    </div>
...
const Symptoms = () => {
  ...
  return (
    <section id="problems" className="py-24 px-6 bg-card">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {list.map((item, idx) => (
            <div key={idx} className="p-6 bg-gray-800/40 border border-border rounded-2xl flex items-start gap-4 hover:border-blue-500/30 transition-colors">
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="space-y-8 text-xl text-muted-foreground">
        ...
        <div className="p-10 bg-gradient-to-br from-blue-600/10 to-indigo-600/10 border border-blue-500/20 rounded-[3rem] text-left relative overflow-hidden group">
          ...
          <h3 className="text-foreground font-bold mb-8 text-3xl">Проблема в отсутствии внешней системы, которая:</h3>
          <ul className="space-y-6">
            <li className="flex items-center gap-4 text-foreground text-lg">
              <CheckCircle2 className="text-primary shrink-0" size={24} /> Видит всю систему целиком
            </li>
            <li className="flex items-center gap-4 text-foreground text-lg">
              <CheckCircle2 className="text-primary shrink-0" size={24} /> Между задачами и направлениями
            </li>
            <li className="flex items-center gap-4 text-foreground text-lg">
              <CheckCircle2 className="text-primary shrink-0" size={24} /> Удерживает фокус на главном
            </li>
            <li className="flex items-center gap-4 text-foreground text-lg">
              <CheckCircle2 className="text-primary shrink-0" size={24} /> Анализирует твои результаты
            </li>
            <li className="flex items-center gap-4 text-foreground text-lg">
              <CheckCircle2 className="text-primary shrink-0" size={24} /> Даёт рекомендации для следующих шагов
            </li>
          </ul>
        </div>
  ...
  return (
    <section className="py-24 px-6 bg-primary relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-black mb-4 text-primary-foreground tracking-tighter">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-white/10 p-10 rounded-[3rem] border border-white/20 backdrop-blur-xl shadow-2xl">
            <h3 className="text-3xl font-black mb-10 text-primary-foreground flex items-center gap-3">
               <Target className="text-primary-foreground" size={32} /> Основная программа
            </h3>
            <div className="space-y-4">
              {mainItems.map((item, idx) => (
                <div key={idx} className="flex items-start gap-4 bg-white/5 p-5 rounded-2xl border border-white/10 hover:bg-white/20 transition-all transform hover:-translate-x-1">
                  <CheckCircle2 className="text-primary-foreground mt-1 shrink-0" size={24} />
                  <span className="text-primary-foreground font-bold text-lg">{item}</span>
                </div>
              ))}
            </div>
          </div>

          <div className="bg-gray-950/40 p-10 rounded-[3rem] border border-border backdrop-blur-md">
            ...
            <div className="bg-blue-900/30 p-8 rounded-3xl border border-blue-500/20">
              ...
              <p className="text-2xl font-black text-foreground leading-tight">У вас будет чёткий план на год</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="program" className="py-24 px-6 bg-gray-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {days.map((item) => (
            <div key={item.day} className="bg-card border border-border rounded-[3rem] p-10 relative hover:border-blue-500/50 transition-all group overflow-hidden">
              ...
              <div className="inline-block px-5 py-2 bg-primary rounded-full text-xs font-black uppercase tracking-widest shadow-xl mb-6">
                Этап {item.day}
              </div>
              ...
              <ul className="space-y-6">
                {item.steps.map((step, sIdx) => (
                  <li key={sIdx} className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-muted border border-border flex items-center justify-center shrink-0 mt-0.5 text-sm font-black text-primary">
                      {sIdx + 1}
                    </div>
...
const Outcomes = () => {
  ...
  return (
    <section className="py-24 px-6 border-y border-border bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/10 rounded-[4rem] p-12 md:p-20 border border-border relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
            {items.map((item, idx) => (
              <div key={idx} className="flex flex-col gap-6 p-8 bg-white/5 rounded-[2rem] border border-border hover:border-blue-500/20 transition-all">
            ...
            <div className="flex flex-col justify-center p-10 bg-gradient-to-br from-primary to-secondary rounded-[2rem] shadow-2xl shadow-blue-500/20">
               <Stars className="text-white/50 mb-4" />
               <p className="text-2xl font-black text-primary-foreground leading-tight">Появляется ощущение тотального контроля и порядка в голове.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="py-24 px-6 relative overflow-hidden bg-gray-950">
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-16">
        <div className="p-6 bg-white/5 rounded-2xl border border-border font-bold uppercase tracking-widest text-xs">AI не устаёт</div>
        <div className="p-6 bg-white/5 rounded-2xl border border-border font-bold uppercase tracking-widest text-xs">Не забывает</div>
        <div className="p-6 bg-white/5 rounded-2xl border border-border font-bold uppercase tracking-widest text-xs">Не отвлекается</div>
      </div>
      <div className="space-y-8 text-xl text-muted-foreground leading-relaxed mb-16">
        ...
        <div className="max-w-2xl mx-auto text-left space-y-5">
          <div className="flex items-center gap-4 text-foreground p-5 bg-white/5 rounded-2xl border border-border hover:bg-white/10 transition-all">
      ...
      <div className="p-10 bg-white/5 border border-border rounded-[3rem] backdrop-blur-md">
        <p className="text-3xl font-black text-foreground">Это не теория. Это калибровка вашей реальности под возможности будущего.</p>
      </div>
    </div>
  </section>
);
...
const Pricing = () => (
  <section id="pricing" className="py-32 px-6 relative">
    <div className="blur-glow bg-primary w-[400px] h-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20" />
    <div className="max-w-4xl mx-auto text-center relative z-10">
      <div className="bg-white text-black p-12 md:p-20 rounded-[4rem] shadow-2xl relative overflow-hidden transform hover:-rotate-1 transition-transform border-[12px] border-white/10">
        ...
        <div className="inline-block px-6 py-2 bg-primary text-primary-foreground rounded-full text-sm font-black uppercase tracking-[0.2em] mb-8">
          16-17 Февраля
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-10">
          ...
          <div className="text-8xl font-black text-primary leading-none">89 €</div>
        </div>
  ...
  return (
    <div className="border-b border-border last:border-0">
      ...
      >
        ...
        <ChevronDown className={`transition-transform duration-300 text-primary ${isOpen ? 'rotate-180' : ''}`} size={28} />
      </button>
      <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-96 pb-8 opacity-100' : 'max-h-0 opacity-0'}`}>
        <p className="text-muted-foreground text-xl font-medium leading-relaxed">{answer}</p>
      </div>
    </div>
  );
};
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/20">
        ...
        <div className="relative flex flex-wrap justify-center gap-8 text-muted-foreground font-bold uppercase tracking-widest text-xs">
          <button onClick={() => setShowSupport(!showSupport)} className="hover:text-foreground transition-colors cursor-pointer bg-transparent border-none text-muted-foreground font-bold uppercase tracking-widest text-xs">Поддержка</button>
          {showSupport && (
            <div className="absolute bottom-full mb-3 bg-gray-900 border border-border rounded-xl p-5 shadow-2xl text-left normal-case tracking-normal min-w-[250px]">
              <p className="text-foreground font-bold text-sm mb-3">Связаться с нами</p>
              <p className="text-muted-foreground text-sm mb-2">📧 support@ailunarfocus.com</p>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-12 border-t border-border">
        ...
        <div className="flex gap-8 text-gray-600 text-xs font-bold uppercase tracking-widest">
          <a href="#" className="hover:text-muted-foreground transition-colors">Политика конфиденциальности</a>
          <a href="#" className="hover:text-muted-foreground transition-colors">Условия использования</a>
        </div>
      </div>
    </div>
  </footer>
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div className="fixed bottom-6 left-6 right-6 z-40 md:hidden">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="block w-full py-5 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-2xl font-black text-lg text-center shadow-2xl"
        >
          Занять место — 89 €
        </a>
      </div>
